...
object PostureTypeSpecs {
    ...
    val ruleTypes: List<RuleTypeSpec> = listOf(
        RuleTypeSpec("file", R.string.zt_posture_type_file, """{"path":"C:\\Program Files\\App\\app.exe","exists":true}""",
            setOf("windows", "mac", "linux")),
        RuleTypeSpec("application", R.string.zt_posture_type_application, """{"path":"C:\\Program Files\\App\\app.exe","thumbprint":""}""",
            setOf("windows", "mac")),
        RuleTypeSpec("os_version", R.string.device_os_version, """{"operator":">=","version":"10.0.0"}""",
            setOf("windows", "mac", "linux", "android", "ios")),
        RuleTypeSpec("firewall", R.string.zt_posture_type_firewall, """{"enabled":true}""",
            setOf("windows", "mac")),
        RuleTypeSpec("disk_encryption", R.string.zt_posture_type_disk_encryption, """{"requireAll":true}""",
            setOf("windows", "mac")),
        RuleTypeSpec("domain_joined", R.string.zt_posture_type_domain_joined, """{"domain":"example.com"}""",
            setOf("windows")),
        ...
        RuleTypeSpec("client_certificate_v2", R.string.zt_posture_type_client_certificate_v2, """{"certificate_id":"<mTLS-CERTIFICATE-UUID>","check_private_key":true,"cn":""}""",
            setOf("windows", "mac", "linux")),
        RuleTypeSpec("serial_number", R.string.zt_posture_type_serial_number, """{"id":"<ACCESS-LIST-UUID>"}""",
            setOf("windows", "mac", "linux", "android", "ios", "chromeos")),
        RuleTypeSpec("unique_client_id", R.string.zt_posture_type_unique_client_id, """{"id":"<LIST-ID>"}""",
        ...
        RuleTypeSpec("sentinelone", R.string.zt_posture_type_sentinelone, """{"path":"C:\\Program Files\\SentinelOne\\SentinelAgent.exe"}""",
            setOf("windows", "mac")),
        RuleTypeSpec("carbonblack", R.string.zt_posture_type_carbonblack, """{"path":"C:\\Program Files\\CarbonBlack\\cb.exe"}""",
            setOf("windows", "mac")),
