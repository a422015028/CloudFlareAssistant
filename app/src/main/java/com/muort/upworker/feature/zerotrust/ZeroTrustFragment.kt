...
class ZeroTrustFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<MaterialCardView>(R.id.devicePostureCard).setOnClickListener {
            findNavController().navigate(R.id.action_zeroTrust_to_devicePosture)
        }
        
        view.findViewById<MaterialCardView>(R.id.groupsCard).setOnClickListener {
