...
class PagesLogsActivity : AppCompatActivity() {
    ...
    private fun connectWebSocket(url: String) {
        runOnUiThread {
            isConnected = false
            connectionStatusDot.background = ContextCompat.getDrawable(this@PagesLogsActivity, R.drawable.circle_yellow)
        ...
        webSocket = client.newWebSocket(request, object : WebSocketListener() {
            ...
            override fun onOpen(webSocket: WebSocket, response: Response) {
                ...
                runOnUiThread {
                    isConnected = true
                    connectionStatusDot.background = ContextCompat.getDrawable(this@PagesLogsActivity, R.drawable.circle_green)
            ...
            override fun onClosing(webSocket: WebSocket, code: Int, reason: String) {
                runOnUiThread {
                    isConnected = false
                    connectionStatusDot.background = ContextCompat.getDrawable(this@PagesLogsActivity, R.drawable.circle_red)
