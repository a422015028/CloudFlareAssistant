...
class MainActivity : AppCompatActivity() {
    ...
    // 记录当前生效的配置，用于 onResume 检测设置页是否修改了配置
    private var currentLanguage: String = ""

    private var currentThemeMode: Int = 0

    private var currentDynamicColor: Boolean = false

    private var currentFontScale: Float = 0f
    ...
    private fun saveCurrentConfig() {
        ...
        currentDynamicColor = ThemeHelper.isDynamicColorEnabled(this)
        currentFontScale = DisplaySizeHelper.getFontScale(this)
    }

    private fun hasConfigChanged(): Boolean {
        return currentLanguage != LocaleHelper.getLanguage(this) ||
                currentThemeMode != ThemeHelper.getThemeMode(this) ||
                currentDynamicColor != ThemeHelper.isDynamicColorEnabled(this) ||
                currentFontScale != DisplaySizeHelper.getFontScale(this)
    }
